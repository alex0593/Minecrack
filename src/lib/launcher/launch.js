// launch.js — Optimized game launch (Rust-delegated heavy computation) — split out of launcher.js
...
import { tauriCmd, ensureDir, readFile, writeFile, fileExists } from '../tauri';
...
import { _javaCacheByVersion, ensureLoaderProfileUpToDate } from './profiles';
